    ...
    ! function (n, e, i, a) {
        n.navigation = function (t, s) {
            ...
            u.showOffcanvas = function () {
                h(), "left" == u.settings.offCanvasSide ? n(t).find(".nav-menus-wrapper").css("transition-property", "right").addClass("nav-menus-wrapper-open") : n(t).find(".nav-menus-wrapper").css("transition-property", "left").addClass("nav-menus-wrapper-open")
                ...
                C = function () {
                    if (g() > u.settings.mobileBreakpoint) {
                        ...
                        n(t).find(".nav-menu").children("li").children(".nav-submenu").each(function () {
                            n(this).parent().position().right + n(this).outerWidth() > e ? n(this).css("left", 0) : n(this).css("left", "auto")
                        })
                    }
                },
                y = function () {
